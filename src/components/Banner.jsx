...
import { FaGithub, FaLinkedin, FaTwitter, FaFacebook, FaTiktok } from 'react-icons/fa';
    ...
    <div className="relative bg-gradient-to-tl from-[#030637] via-[#3c0753] to-[#720455] min-h-screen overflow-hidden text-white">
      ...
      <div className="block md:hidden px-6 py-10 space-y-10">
        ...
        <div className="w-full flex flex-col items-center" data-aos="fade-right">
          <h1 className="text-3xl sm:text-4xl font-extrabold mb-6 text-center">About Me</h1>
        ...
        <main className="flex-1 px-6 py-10">
          <h1 className="text-4xl font-bold text-center text-yellow-300 mb-12" data-aos="fade-down">
            Projects
          </h1>
            ...
            {projects.map((proj, index) => (
              <React.Fragment key={index}>
                ...
                >
                  ...
                  <div className="p-4">
                    <h2 className="font-bold text-lg mb-2 text-black" data-aos="fade-right">
                      {proj.title}
                    </h2>
                    <p className="text-gray-600 mb-4 font-bold" data-aos="fade-left">
                      {proj.skillset}
                    </p>
